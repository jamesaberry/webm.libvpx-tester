...
double vpxt_psnr_resize_frames(const char *inputFile1, const char *inputFile2, int forceUVswap, int frameStats, int printvar, double *SsimOut, int resizeHeight, int resizeWidth);
...
int vpxt_formatted_to_raw(const std::string inputFile, const std::string outputDir);
int vpxt_formatted_to_raw_frames(std::string inputFile, std::string outputDir);
