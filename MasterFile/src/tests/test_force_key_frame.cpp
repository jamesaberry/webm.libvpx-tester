...
int test_force_key_frame(int argc, char *argv[], string WorkingDir, string FilesAr[], int TestType)
{
    ...
    int NumberofFrames = vpxt_get_number_of_frames(ForceKeyFrame.c_str());
