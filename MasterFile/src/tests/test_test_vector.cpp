                     ...
                     int DeleteIVF)
{
    ...
    while (TestVectorNum < 102)
    {
        vpxt_remove_file_extension(TestVector_Raw[TestVectorNum].c_str(),
            TestVector_Text[TestVectorNum]);
    ...
    MD5Key[17].assign("53b08ac91398a5dd948434e41b31b47e");
    /*vp80-01-intra-1411.raw*/
    MD5Key[18].assign("8fa1762329e65c97245393a933cd0f00");
     /*vp80-01-intra-1416.raw*/
    MD5Key[19].assign("cffd1299fa7a0330264cb411d9482bb0");
    /*vp80-01-intra-1417.raw*/
    MD5Key[20].assign("0e6c13a78a203d95fe12d206a432f642");
    /*vp80-02-inter-1402.raw*/
    MD5Key[21].assign("184ee9c5cd6e32f2fe7b2f5a463d37b3");
    /*vp80-02-inter-1412.raw*/
    MD5Key[22].assign("6928dc8e7886914b0ba5825518e54bd7");
    /*vp80-02-inter-1418.raw*/
    MD5Key[23].assign("45302aa645ff5c139fe580ac30482245");
    /*vp80-02-inter-1424.raw*/
    MD5Key[24].assign("4816cb607488b930ceadeb2cdb034c49");
    /*vp80-03-segmentation-1401.raw*/
    MD5Key[25].assign("f7acb74e99528568714129e2994ceca5");
    /*vp80-03-segmentation-1403.raw*/
    MD5Key[26].assign("4e651f545a21863e97547185f93dbd7b");
    /*vp80-03-segmentation-1407.raw*/
    MD5Key[27].assign("fa76612d673cbfcb8ec58eda08400388");
    /*vp80-03-segmentation-1408.raw*/
    MD5Key[28].assign("886f15167bbdd5ea6c099e8b74452c7c");
    /*vp80-03-segmentation-1409.raw*/
    MD5Key[29].assign("780cc4d060eecec04c2746c98065ec6f");
    /*vp80-03-segmentation-1410.raw*/
    MD5Key[30].assign("f3468778cd11642f095b4e5dcb19fbda");
    /*vp80-03-segmentation-1413.raw*/
    MD5Key[31].assign("6a0564ccc1a655d929390a72ff558db9");
    /*vp80-03-segmentation-1414.raw*/
    MD5Key[32].assign("0f887b4bc1bb0aae670c50c9b7f0142f");
    /*vp80-03-segmentation-1415.raw*/
    MD5Key[33].assign("8b83e0a3ca0da9e8d7f47a06dc08e18b");
    /*vp80-03-segmentation-1425.raw*/
    MD5Key[34].assign("96ffacf0c3eae59b58252be24a60e9b2");
    /*vp80-03-segmentation-1426.raw*/
    MD5Key[35].assign("ab1062e4e45e6802d80313da52028af2");
    /*vp80-03-segmentation-1427.raw*/
    MD5Key[36].assign("761c3d8e23314516592a1f876865c22a");
    /*vp80-03-segmentation-1432.raw*/
    MD5Key[37].assign("c5a7776fdfe8908fcc64e58c317c8cf3");
    /*vp80-03-segmentation-1435.raw*/
    MD5Key[38].assign("36a77df963d0d8c3bc098827be403bdb");
    /*vp80-03-segmentation-1436.raw*/
    MD5Key[39].assign("bfd17a557ee1ba347c755a18ce5a64a6");
    /*vp80-03-segmentation-1437.raw*/
    MD5Key[40].assign("876e7c782ee4dd23866498b794856fd1");
    /*vp80-03-segmentation-1441.raw*/
    MD5Key[41].assign("d7a1e99d0ec80ac2b95cc7277bf4db3c");
    /*vp80-03-segmentation-1442.raw*/
    MD5Key[42].assign("1a23409897f51ad2920d5ddb999eac71");
    /*vp80-04-partitions-1404.raw*/
    MD5Key[43].assign("27837df047de5b5ae2dc8f2e9d318cb3");
    /*vp80-04-partitions-1405.raw*/
    MD5Key[44].assign("12fb1d187ee70738265d8f3a0a70ef26");
    /*vp80-04-partitions-1406.raw*/
    MD5Key[45].assign("2da53f93a051dcb8290f884a55272dd9");
    /*vp80-05-sharpness-1428.raw*/
    MD5Key[46].assign("14b537dae40c6013079fd3d25cb16e7a");
    /*vp80-05-sharpness-1429.raw*/
    MD5Key[47].assign("e836423126f8a7de2c6c9777e0a84214");
    /*vp80-05-sharpness-1430.raw*/
    MD5Key[48].assign("51503f7a786032d2cbed84ed11430ff3");
    /*vp80-05-sharpness-1431.raw*/
    MD5Key[49].assign("7f7f534b2d6e28002e119ed269c8f282");
    /*vp80-05-sharpness-1433.raw*/
    MD5Key[50].assign("a2ff07ccbb019f48e020507ca5f5ee90");
    /*vp80-05-sharpness-1434.raw*/
    MD5Key[51].assign("110a65e1729fc54e0a25dbf9cc367ccf");
    /*vp80-05-sharpness-1438.raw*/
    MD5Key[52].assign("cc468ac5ce042c85f04d62a8e09c97ff");
    /*vp80-05-sharpness-1439.raw*/
    MD5Key[53].assign("ebfc41ade751e96220e74491bffda736");
    /*vp80-05-sharpness-1440.raw*/
    MD5Key[54].assign("903a267bcc69ad5f8d886db6478d997a");
    /*vp80-05-sharpness-1443.raw*/
    MD5Key[55].assign("3c5c3c66cad414d6b79de77e977f115b");
    /*vp80-06-cropping-001.raw*/
    MD5Key[56].assign("9f8e73e634493ab3e56aad63321f8e11");
    /*vp80-06-cropping-002.raw*/
    MD5Key[57].assign("aef0cfaf282d07cd7ac360fb4f7a1f6b");
    /*vp80-06-cropping-003.raw*/
    MD5Key[58].assign("609e845f662e3455daf57c68b859a4f6");
    /*vp80-06-cropping-004.raw*/
    MD5Key[59].assign("c37c1c11bf3f5adcfa62a39b35cf3d07");
    /*vp80-06-cropping-005.raw*/
    MD5Key[60].assign("82641ff61fe1d6bb7ba8accfa5b399ad");
    /*vp80-06-cropping-006.raw*/
    MD5Key[61].assign("b8fa425191154685444164157bfbf53d");
    /*vp80-06-cropping-007.raw*/
    MD5Key[62].assign("ee19c6b8947c3521b810b66ae080368a");
    /*vp80-06-cropping-008.raw*/
    MD5Key[63].assign("1d99ee17a5ba002dbb185a00ea517427");
    /*vp80-06-cropping-009.raw*/
    MD5Key[64].assign("017e2e8066397e6f4fdf9522cc2d3428");
    /*vp80-06-cropping-010.raw*/
    MD5Key[65].assign("2e66d33de5a4550b168524b569799858");
    /*vp80-06-cropping-011.raw*/
    MD5Key[66].assign("3afdb776a6260ab3a3722d5ed0a51ea6");
    /*vp80-06-cropping-012.raw*/
    MD5Key[67].assign("ee370c45dd534c994e83454962f05e4a");
    /*vp80-06-cropping-013.raw*/
    MD5Key[68].assign("de95d19355f402c2ce9a75562ef45a88");
    /*vp80-06-cropping-014.raw*/
    MD5Key[69].assign("79d1c72208f9a40a770a065b48d7c9b6");
    /*vp80-06-cropping-015.raw*/
    MD5Key[70].assign("eac91c3f679b57fb0d41965a58515c58");
    /*vp80-06-cropping-016.raw*/
    MD5Key[71].assign("1ade1e1d87d045a3df99c1c4431c3770");
    /*vp80-06-cropping-017.raw*/
    MD5Key[72].assign("a92acb085407d9f38d6b86a25dcd31b6");
    /*vp80-06-cropping-018.raw*/
    MD5Key[73].assign("633ab126a1f74babedef090b7a9f79f3");
    /*vp80-06-cropping-019.raw*/
    MD5Key[74].assign("336b86b25f320eb63eb0476ab84229cd");
    /*vp80-06-cropping-020.raw*/
    MD5Key[75].assign("d4bf42f6671d06dbda405c105984f4a6");
    /*vp80-06-cropping-021.raw*/
    MD5Key[76].assign("a857394e5ad0b52ffcffd61d0be108ed");
    /*vp80-06-cropping-022.raw*/
    MD5Key[77].assign("2f985c573f020c5bac55d48fa5e24489");
    /*vp80-06-cropping-023.raw*/
    MD5Key[78].assign("8a56b8c71b671503018727917fcdb145");
    /*vp80-06-cropping-024.raw*/
    MD5Key[79].assign("2369693e71dcb565327b49c31fdc513e");
    /*vp80-06-cropping-025.raw*/
    MD5Key[80].assign("9be67b80d50f157bbae891e2a465909e");
    /*vp80-06-cropping-026.raw*/
    MD5Key[81].assign("20ed8b808ad8f3be05a9c80e0328f0e5");
    /*vp80-06-cropping-027.raw*/
    MD5Key[82].assign("d4178440ab559d89df2d036c6606cda6");
    /*vp80-06-cropping-028.raw*/
    MD5Key[83].assign("c65520731d9caae321de26fa41e77bf2");
    /*vp80-06-cropping-029.raw*/
    MD5Key[84].assign("097c3f56e8917306fa5f1a60e63c95b9");
    /*vp80-06-cropping-030.raw*/
    MD5Key[85].assign("f52c5fc26a9439aa8226d533bcdada98");
    /*vp80-06-cropping-031.raw*/
    MD5Key[86].assign("5df73922d1ed6680e4d2ac35d86b061a");
    /*vp80-06-cropping-032.raw*/
    MD5Key[87].assign("9d9a31179bfb0daf3a884625e7f1c116");
    /*vp80-06-cropping-033.raw*/
    MD5Key[88].assign("bbafe2fdf7b927ff0b403f91646ed80b");
    /*vp80-06-cropping-034.raw*/
    MD5Key[89].assign("b2d27a6f08e37e1a26bfd31e229684d8");
    /*vp80-06-cropping-035.raw*/
    MD5Key[90].assign("dd5138a4831475284d285a6e821387d6");
    /*vp80-06-cropping-036.raw*/
    MD5Key[91].assign("8fd17178a7d163a8eb9b439d9fa42797");
    /*vp80-06-cropping-037.raw*/
    MD5Key[92].assign("0e7960d1d71e1aa5a97d22f152c10a8f");
    /*vp80-06-cropping-038.raw*/
    MD5Key[93].assign("84b6553703153de46aefb09bc479bca5");
    /*vp80-06-cropping-039.raw*/
    MD5Key[94].assign("971f42513a93493c4c7bce8177a07da4");
    /*vp80-06-cropping-040.raw*/
    MD5Key[95].assign("98e3e9253baa99f5bf40316eb54d9e36");
    /*vp80-06-cropping-041.raw*/
    MD5Key[96].assign("1e57bb03f8872d07d64a3177d2a31ceb");
    /*vp80-06-cropping-042.raw*/
    MD5Key[97].assign("1a2360cc18b06016777fb9614ac4de61");
    /*vp80-06-cropping-043.raw*/
    MD5Key[98].assign("18924afc1f5acb60d3933184ff1f93c8");
    /*vp80-06-cropping-044.raw*/
    MD5Key[99].assign("62f5de3feb4346072c94d643d6946fb4");
    /*vp80-06-cropping-045.raw*/
    MD5Key[100].assign("8319b0f71a76787f894f2927b7923897");
    ...
    else
    {
        ...
        while (CurTestVector < LastTestVector)
        {
            ...
            if (vpxt_decompress_to_raw(TestVector[CurTestVector].c_str(),
                TestVector_Raw[CurTestVector].c_str(), threads) == -1)
            {
                fclose(fp);
    ...
    while (CurTestVector < LastTestVector)
    {
        ...
        tprintf(PRINT_ERR, "\n\nComputing MD5 for TestVector %i\n",
            CurTestVector);
        vpxt_dec_compute_md5(TestVector[CurTestVector].c_str(),
            TestVector_Text[CurTestVector].c_str());
        CurTestVector++;
    }
    ...
    {
        std::string FailStr = "Not all decoded test vectors match expected "
            "MD5 checksum's.";
