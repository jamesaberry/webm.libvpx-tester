    ...
    while (!WorkingTextFile.eof())
    {
        ...
        else
        {
            ...
            if (CommentBool == 0)
            {
                ...
                {
                    SelectorAr[SelectorArInt] = "Test_Copy_Set_Reference";
                    check_time_stamp(SelectorArInt, SelectorAr, SelectorAr2, TimeStampPrevious, identicalFileVar, TimeStampAr2);
                    SelectorAr2[SelectorArInt] = TimeStampAr2[0];
                    ...
                    PassFail[PassFailInt] = test_copy_set_reference(DummyArgvVar, (char **)DummyArgv, TestDir, TimeStampAr2, TestType, DeleteIVFFiles);
                ...
                {
                    SelectorAr[SelectorArInt] = "Test_Error_Concealment";
                    check_time_stamp(SelectorArInt, SelectorAr, SelectorAr2, TimeStampPrevious, identicalFileVar, TimeStampAr2);
                    SelectorAr2[SelectorArInt] = TimeStampAr2[0];
                    ...
                    PassFail[PassFailInt] = test_error_concealment(DummyArgvVar, (char **)DummyArgv, TestDir, TimeStampAr2, TestType, DeleteIVFFiles);
                ...
                {
                    SelectorAr[SelectorArInt] = "Test_Multiple_Resolution_Encode";
                    check_time_stamp(SelectorArInt, SelectorAr, SelectorAr2, TimeStampPrevious, identicalFileVar, TimeStampAr2);
                    SelectorAr2[SelectorArInt] = TimeStampAr2[0];
                    ...
                    PassFail[PassFailInt] = test_multiple_resolution_encode(DummyArgvVar, (char **)DummyArgv, TestDir, TimeStampAr2, TestType, DeleteIVFFiles);
                ...
                if (selector == MULTDNUM)
                {
                    ...
                    PassFail[PassFailInt] = test_multithreaded_dec(DummyArgvVar, (char **)DummyArgv, TestDir, TimeStampAr2, TestType, DeleteIVFFiles);
                ...
                {
                    SelectorAr[SelectorArInt] = "Test_Multithreaded_Enc";
                    check_time_stamp(SelectorArInt, SelectorAr, SelectorAr2, TimeStampPrevious, identicalFileVar, TimeStampAr2);
                    SelectorAr2[SelectorArInt] = TimeStampAr2[0];
                    ...
                    PassFail[PassFailInt] = test_multithreaded_enc(DummyArgvVar, (char **)DummyArgv, TestDir, TimeStampAr2, TestType, DeleteIVFFiles);
                ...
                {
                    SelectorAr[SelectorArInt] = "Test_Temporal_Scalability";
                    check_time_stamp(SelectorArInt, SelectorAr, SelectorAr2, TimeStampPrevious, identicalFileVar, TimeStampAr2);
                    SelectorAr2[SelectorArInt] = TimeStampAr2[0];
                    ...
                    PassFail[PassFailInt] = test_temporal_scalability(DummyArgvVar, (char **)DummyArgv, TestDir, TimeStampAr2, TestType, DeleteIVFFiles);
