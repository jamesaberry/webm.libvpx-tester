...
VP8_CONFIG VP8RandomParms(VP8_CONFIG &opt)
{
    int randnum;
    float randomCalc;
    ...
    randnum = rand() % 100;
    randomCalc = (300 * randnum / 100.0) + 1;
    opt.KeyFreq = randomCalc;
    cout << "ForceKeyFrameEvery " << opt.KeyFreq << "\n";
    cerr << "ForceKeyFrameEvery " << opt.KeyFreq << "\n";

    randnum = rand() % 101;
    randomCalc = 6 * (randnum / 100.0);
    opt.NoiseSensitivity = randomCalc;
    cout << "NoiseSensitivity " << opt.NoiseSensitivity << "\n";
    cerr << "NoiseSensitivity " << opt.NoiseSensitivity << "\n";

    randnum = rand() % 101;
    randomCalc = 16 * (randnum / 100.0);
    opt.MultiThreaded =  randomCalc;
    cout << "MultiThreaded " << opt.MultiThreaded << "\n";
    cerr << "MultiThreaded " << opt.MultiThreaded << "\n";

    randnum = rand() % 101;
    randomCalc = 600 * randnum / 100.0;
    opt.TargetBandwidth = randomCalc;
    cout << "TargetBandwidth " << opt.TargetBandwidth << "\n";
    cerr << "TargetBandwidth " << opt.TargetBandwidth << "\n";

    randnum = rand() % 101;
    opt.UnderShootPct = randnum;
    cout << "UnderShootPct " << opt.UnderShootPct << "\n";
    cerr << "UnderShootPct " << opt.UnderShootPct << "\n";

    randnum = rand() % 101;
    randomCalc = 200 * (randnum / 100.0) + 100;

    randnum = rand() % 101;
    randomCalc = 63 * randnum / 100.0;
    opt.BestAllowedQ = randomCalc;
    ...
    randnum = rand() % 101;
    randomCalc = 25 * (randnum / 100.0);
    opt.MaximumBufferSize  = randomCalc;
    ...
    /////////////////////Need to set up Randoms for below///////////////////////////////////////////////
    randnum = rand() % 101;
    randomCalc = (1000 * (randnum / 100.0)) + 100;
    opt.AllowLag = randomCalc;
    cout << "AllowLag " << opt.AllowLag << "\n";
    cerr << "AllowLag " << opt.AllowLag << "\n";

    randnum = rand() % 101;
    randomCalc = (1000 * (randnum / 100.0)) + 100;
    opt.AltFreq = randomCalc;
...
{
    //function returns 1 if input is correct 0 if not correct and 3 if there is an error
        ...
        else
        {
            ...
            if (CommentBool == 0)
            {
                ...
                if (selector == 9)
                {
                    if (!(DummyArgvVar == 6 || DummyArgvVar == 5))
                    {
                        SelectorAr2[SelectorArInt] = "ChangeIDCTDecWorks";
                        PassFail[PassFailInt] = trackthis1;
                    }
                    else
                    {
                ...
                if (selector == 10)
                {
                    if (!(DummyArgvVar == 6 || DummyArgvVar == 5))
                    {
                        SelectorAr2[SelectorArInt] = "ChangeIDCTWorks";
                        PassFail[PassFailInt] = trackthis1;
                    }
                    else
                    {
                ...
                if (selector == 11)
                {
                    ...
                    {
                        SelectorAr2[SelectorArInt] = "ComboTestRun";
                        PassFail[PassFailInt] = trackthis1;
                    }
                    else
                    {
                ...
                if (selector == 13)
                {
                    if (!(DummyArgvVar == 6 || DummyArgvVar == 5))
                    {
                        SelectorAr2[SelectorArInt] = "DataRateMaxWorks";
                        PassFail[PassFailInt] = trackthis1;
                    }
                    else
                    {
                ...
                if (selector == 20)
                {
                    if (!(DummyArgvVar == 6 || DummyArgvVar == 5))
                    {
                        SelectorAr2[SelectorArInt] = "IDCTDecOnlyWorks";
                        PassFail[PassFailInt] = trackthis1;
                    }
                    else
                    {
                ...
                if (selector == 21)
                {
                    if (!(DummyArgvVar == 6 || DummyArgvVar == 5))
                    {
                        SelectorAr2[SelectorArInt] = "InterlaceWorks";
                        PassFail[PassFailInt] = trackthis1;
                    }
                    else
                    {
                ...
                if (selector == 22)
                {
                    if (!(DummyArgvVar == 6 || DummyArgvVar == 7))
                    {
                        SelectorAr2[SelectorArInt] = "KeyInKeyOutWorks";
                        PassFail[PassFailInt] = trackthis1;
                    }
                    else
                    {
                ...
                if (selector == 28)
                {
                    if (!(DummyArgvVar == 6 || DummyArgvVar == 7))
                    {
                        SelectorAr2[SelectorArInt] = "NewvsOldSpeed";
                        PassFail[PassFailInt] = trackthis1;
                    }
                    else
                    {
                ...
                if (selector == 33)
                {
                    if (!(DummyArgvVar == 6 || DummyArgvVar == 7))
                    {
                        SelectorAr2[SelectorArInt] = "PSNRTest";
                        PassFail[PassFailInt] = trackthis1;
                    }
                    else
                    {
                ...
                if (selector == 35)
                {
                    if (!(DummyArgvVar == 3 || DummyArgvVar == 4))
                    {
                        SelectorAr2[SelectorArInt] = "RunRandomizedTest";
                        PassFail[PassFailInt] = trackthis1;
                    }
                    else
                    {
                ...
                if (selector == 39)
                {
                    if (!(DummyArgvVar == 6 || DummyArgvVar == 7))
                    {
                        SelectorAr2[SelectorArInt] = "VP61vVP62";
                        PassFail[PassFailInt] = trackthis1;
                    }
                    else
                    {
                ...
                if (selector == 40)
                {
                    if (!(DummyArgvVar == 6 || DummyArgvVar == 7))
                    {
                        SelectorAr2[SelectorArInt] = "VP6MvVP60";
                        PassFail[PassFailInt] = trackthis1;
                    }
                    else
                    {
...
double IVFPSNR(char *inputFile1, char *inputFile2, int forceUVswap, int frameStats, int printvar)
{
...
double IVFPSNR_CORE(char *inputFile1, char *inputFile2, int forceUVswap, int frameStats, int printvar)
{
    double summedQuality = 0;
    double summedWeights = 0;
    double summedPsnr = 0;
...
double PostProcIVFPSNR(char *inputFile1, char *inputFile2, int forceUVswap, int frameStats, int printvar, int deblock_level, int noise_level, int flags)
{
    double summedQuality = 0;
    double summedWeights = 0;
    double summedPsnr = 0;
...
double PostProcIVFPSNR_CORE(char *inputFile1, char *inputFile2, int forceUVswap, int frameStats, int printvar, int deblock_level, int noise_level, int flags)
{
    double summedQuality = 0;
    double summedWeights = 0;
    double summedPsnr = 0;
...
#endif
//--------------------------------------------------------IVF Tools-------------------------------------------------------------------------
int CopyIVFtoIVF(char *inputFile, char *outputFile, int StartingFrame, int EndingFrame)
{
    bool verbose = 1;
...
int CopyIVFtoIVF2(char *inputFile1, char *inputFile2, char *outputFile, int StartingFrame)
{
    bool verbose = 1;
...
int DisplayIVFHeaderInfo(int argc, char *argv[])
{
    ...
    if (argc > 4)
    {
        ...
        char *inputVideoBuffer = new char[ivf_fhRaw.frameSize];
        fread(inputVideoBuffer, 1, ivf_fhRaw.frameSize, in);
        delete [] inputVideoBuffer;
...
int CompareIVFHeaderInfo(int argc, char *argv[])
{
    ...
    if (argc < 6) //if not output file
    {
        ...
        char *inputVideoBuffer1 = new char[ivf_fhRaw.frameSize];
        fread(inputVideoBuffer1, 1, ivf_fhRaw.frameSize, in);
        delete [] inputVideoBuffer1;
        ...
        char *inputVideoBuffer2 = new char[ivf_fhRaw2.frameSize];
        fread(inputVideoBuffer2, 1, ivf_fhRaw2.frameSize, in2);
        delete [] inputVideoBuffer2;
    ...
    else
    {
        ...
        while (currentVideoFrame < frameCount)
        {
            ...
            if (currentVideoFrame <= (ivfhRaw.length - 1))
            {
                fread(&ivf_fhRaw.frameSize, 1, 4, in);
                fread(&ivf_fhRaw.timeStamp, 1, 8, in);
                FormatFrameHeaderRead(ivf_fhRaw);
            ...
            //if file 2 isnt at the end read the next data in
            if (currentVideoFrame <= (ivfhRaw2.length - 1))
            {
                fread(&ivf_fhRaw2.frameSize, 1, 4, in2);
                fread(&ivf_fhRaw2.timeStamp, 1, 8, in2);
                FormatFrameHeaderRead(ivf_fhRaw2);
            ...
            if (currentVideoFrame <= (ivfhRaw2.length - 1) && currentVideoFrame <= (ivfhRaw.length - 1))
            {
            ...
            if (currentVideoFrame <= (ivfhRaw2.length - 1) && !(currentVideoFrame <= (ivfhRaw.length - 1)))
            {
                ...
                fprintf(stderr, "                                    FRAME HEADER2 %i\n"
                        "                                    Frame Size            - %i\n"
                        "                                    Time Stamp            - %i\n"
                        "\n"
                        ...
                        , currentVideoFrame
                        , ivf_fhRaw2.frameSize
                        , ivf_fhRaw2.timeStamp);
            }

            if (!(currentVideoFrame <= (ivfhRaw2.length - 1)) && currentVideoFrame <= (ivfhRaw.length - 1))
            {
                printf("FRAME HEADER1 %-*i\n"
                       "Frame Size            - %-*i\n"
                       "Time Stamp            - %-*i\n"
                       "\n"
                ...
                fprintf(stderr, "FRAME HEADER1 %-*i\n"
                        "Frame Size            - %-*i\n"
                        "Time Stamp            - %-*i\n"
                        "\n"
