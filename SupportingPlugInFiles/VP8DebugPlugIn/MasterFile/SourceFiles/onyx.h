...
// and not just a copy of the pointer..
    ...
    int vp8_get_compressed_data(VP8_PTR comp, unsigned int *frame_flags, unsigned long *size, char *dest, INT64 *time_stamp, INT64 *time_end, int flush);
    ...
    int vp8_set_roimap(VP8_PTR comp, unsigned char *map, int rows, int cols, int delta_q[4], int delta_lf[4], int threshold[4]);
    int vp8_set_active_map(VP8_PTR comp, unsigned char *map, int rows, int cols);
